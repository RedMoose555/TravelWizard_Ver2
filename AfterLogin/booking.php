<?php
// Start the session to store user information across pages
session_start();
...
<?php
// Retrieve POST data for hidden fields if available
...
<form action="confirm_booking.php" method="POST" id="bookingForm">
  <!-- Hidden fields to pass package and flight information -->
  ...
  <section>
    ...
    <!-- Allergies checkbox that shows additional input field when selected -->
