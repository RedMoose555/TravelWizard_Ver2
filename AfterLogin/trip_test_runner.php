<?php
// Include trips logic (no session/auth needed for this test)
require 'db.php'; // if your $trips array is stored separately, include that file
// OR paste your full $trips array here instead
